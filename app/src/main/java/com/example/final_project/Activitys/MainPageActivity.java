   ...
   private DatabaseReference myRefKindergarten;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // writeUserData();
        ...
        Log.d("ptt","currentUserData.isAdmin() ->" + currentUserData.isAdmin());
    ...
    private void openCalendarActivity() {
        ...
        Log.d("ptt","IN openCalendarActivity-> "+currentUserData.isAdmin());
        intent.putExtra(Constants.IS_USER_ADMIN, currentUserData.isAdmin());
    ...
    private void addKindergarten() {
        ...
        Log.d("ptt","IN addKindergarten -> after create garten");
        kindergarten.getSongList().add("Aviv");
        kindergarten.getSongList().add("Peshach");
        kindergarten.getSongList().add("Summer");
